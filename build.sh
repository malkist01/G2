...
#
SECONDS=0
ZIPNAME="runes-cosmicdrop-sma72-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
TC_DIR="$(pwd)/../tc/"
CLANG_DIR="${TC_DIR}clang"
GCC_64_DIR="${TC_DIR}aarch64-linux-android-4.9"
GCC_32_DIR="${TC_DIR}arm-linux-androideabi-4.9"
AK3_DIR="$(pwd)/AnyKernel3"
DEFCONFIG="vendor/samsung/sma72_defconfig"
...
git clone -b a72q -q https://github.com/frstprjkt/AnyKernel3 || {
