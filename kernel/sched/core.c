...
static void uclamp_set(struct cgroup_subsys_state *css)
{
	...
	static struct uclamp_param tgts[] = {
		{"top-app",            "35",  "max",  1, 1, 20480},
		{"rt",			"0",  "max",  1, 0, 20480},
		{"nnapi-hal",		"0",  "80",  1, 0, 20480},
       		{"foreground",          "20",  "80",  1, 0, 20480},
                {"camera-daemon",      "25",  "90",  1, 1, 20480},
                {"system",              "0",  "60",  0, 0, 20480},
                {"dex2oat",             "0",  "60",   0, 0,   512},
        	{"background",          "0",  "40",   0, 0,  1024},
        	{"system-background",   "0",  "40",   0, 0,  1024},
	};
